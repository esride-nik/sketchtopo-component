...
describe('sketchtopo-component', () => {
  ...
  it('renders with values', async () => {
    const { root } = await newSpecPage({
      components: [SketchTopoComponent],
      html: `<sketchtopo-component checkThese="Stencil" last="'Don't call me a framework' JS"></sketchtopo-component>`,
    });
    expect(root).toEqualHtml(`
      <sketchtopo-component checkThese="Stencil" last="'Don't call me a framework' JS">
        <mock:shadow-root>
          <div>
